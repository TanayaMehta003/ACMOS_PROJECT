...
# Load the CSV file
file_path = 'n_gmro.csv'  # Replace this with the path to your CSV file
...
for (x_col, y_col), l_pmos_nm in zip(zip(x_columns, y_columns), l_nmos_values_nm):
    plt.plot(data[x_col], data[y_col], label=f"L_nmos = {l_pmos_nm} nm")  # No marker for smooth lines
